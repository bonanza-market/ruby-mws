...
class String
  ...
  alias :old_camelize :camelize

  def camelize(first_letter_in_uppercase = true)
    # this monkey patch is ommiting original camelize method behavior, possible symbol values are :lower and :upper (which is default)
    if first_letter_in_uppercase.kind_of?(Symbol)
      old_camelize(first_letter_in_uppercase)
